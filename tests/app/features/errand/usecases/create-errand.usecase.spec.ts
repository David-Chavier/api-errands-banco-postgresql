...
describe("testando usecase de criação de recados", () => {
  beforeAll(async () => {
  ...
  test("Deveria retornar 200 se o recado for criado", async () => {
    const sut = createSut();
    ...
    jest.spyOn(ErrandsRepository.prototype, "create").mockResolvedValue();
    ...
    expect(result.message).toBe("Errand was successfully add");
